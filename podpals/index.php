...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top">
        <a class="navbar-brand" href="#"><img src="images/podpals_logo_round.png"></a>
            ...
            <div class="group-sec">
                <div class="contact-sec">
                    <div class="contact-pic">
                        <a href="boo.html"><img src="images/boo-pro-pic.png" /></a>
                    </div>
                </div>
                ...
                <div class="photos-sec">
                    ...
                    <div class="photo-block">
                        <img src="images/couple-date-small.jpeg" class="first" onclick="openModal();currentSlide(0)" />
                    </div>
                    <div class="photo-block">
